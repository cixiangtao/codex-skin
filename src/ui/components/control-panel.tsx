...
export function ControlPanel({
  ...
  return (
    <aside
      className="static border border-ink/14 bg-paper/80 p-6 shadow-[14px_14px_0_rgb(45_106_79/0.08),0_28px_70px_rgb(59_53_36/0.08)] backdrop-blur-[18px] lg:grid lg:min-h-0 lg:grid-rows-[auto_minmax(0,1fr)] lg:overflow-hidden"
